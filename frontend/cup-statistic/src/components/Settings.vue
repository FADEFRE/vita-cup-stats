<script setup>
import { getAllChamps, getAllTeams, postMatch } from "@/requests/requests.js";
	...
	<div class="settings_body">
		...
		<div class="settings_area">
			...
			<div class="horizontal_align">
				<InputNumber v-model="teamOne_Score" class="input" />
				<InputNumber v-model="teamTwo_Score" class="input" />
			</div>

			<div class="heading_wrap">MVP</div>
			<InputText v-model="mvp" class="input" />
			...
			<Button class="button" label="Submit" @click="clicked()" />
		</div>
